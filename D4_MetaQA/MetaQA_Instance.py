...
def GenerationImage(rootpath, saveImgpath,modeNUM):
    ...
    plt.legend(handles=legend_elements, loc='upper center', ncol=3, bbox_to_anchor=(-0.9, 2.2), prop=font_properties,labelspacing=0.05)
    plt.subplots_adjust(top=0.6, left=0.08, right=0.99,bottom=0.25)
